 ...
 * be grouped as one using {@link #anyOf(jsr166e.CompletableFuture...)} and
 * {@link #allOf(jsr166e.CompletableFuture...)}.
 *
 ...
 * action using either a given {@link java.util.concurrent.Executor} or by default the
 * {@link jsr166e.ForkJoinPool#commonPool()}. To simplify monitoring,
 * debugging, and tracking, all generated asynchronous tasks are
 * instances of the marker interface {@link jsr166e.CompletableFuture.AsynchronousCompletionTask}.
 *
 ...
 *
 * <p>Since (unlike {@link java.util.concurrent.FutureTask}) this class has no direct
 ...
 * {@link java.util.concurrent.ExecutionException} with the same cause as held in the
...
public class CompletableFuture<T> implements Future<T> {
     ...
     * by a task running in the {@link jsr166e.ForkJoinPool#commonPool()} with
    ...
    /**
     * Returns a new CompletableFuture that is asynchronously completed
     * by a task running in the {@link jsr166e.ForkJoinPool#commonPool()} after
     ...
     * task running in the {@link jsr166e.ForkJoinPool#commonPool()}.
     *
     * <p>If this CompletableFuture completes exceptionally, or the
     * supplied function throws an exception, then the returned
     * CompletableFuture completes exceptionally with a
     ...
     * in the {@link jsr166e.ForkJoinPool#commonPool()}.
     *
     * <p>If this CompletableFuture completes exceptionally, or the
     * supplied action throws an exception, then the returned
     * CompletableFuture completes exceptionally with a
     ...
     * Returns a new CompletableFuture that is asynchronously completed
     * when this CompletableFuture completes, after performing the given
     * action from a task running in the {@link jsr166e.ForkJoinPool#commonPool()}.
     *
     * <p>If this CompletableFuture completes exceptionally, or the
     * supplied action throws an exception, then the returned
     * CompletableFuture completes exceptionally with a
     ...
     * {@link jsr166e.ForkJoinPool#commonPool()}.
     *
     * <p>If this and/or the other CompletableFuture complete
     * exceptionally, or the supplied function throws an exception,
     * then the returned CompletableFuture completes exceptionally
     ...
     * jsr166e.ForkJoinPool#commonPool()}.
     *
     * <p>If this and/or the other CompletableFuture complete
     * exceptionally, or the supplied action throws an exception,
     * then the returned CompletableFuture completes exceptionally
     ...
     * the {@link jsr166e.ForkJoinPool#commonPool()}.
     *
     * <p>If this and/or the other CompletableFuture complete
     * exceptionally, then the returned CompletableFuture may also do so,
     * with a CompletionException holding one of these exceptions as its
     ...
     * jsr166e.ForkJoinPool#commonPool()} by the given function of the result
     ...
     * a {@link java.util.concurrent.CancellationException}. Dependent CompletableFutures
