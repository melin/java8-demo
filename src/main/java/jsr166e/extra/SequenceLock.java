...
/**
 * A reentrant mutual exclusion {@link java.util.concurrent.locks.Lock} in which each lock
 ...
 * or {@link java.util.concurrent.locks.Condition} objects, a SequenceLock can be used in the
 * same way as {@link java.util.concurrent.locks.ReentrantLock}. It provides similar status and
...
public class SequenceLock implements Lock, java.io.Serializable {
     ...
     * this method throws {@link java.util.concurrent.TimeoutException}.
     *
     * </ul>
     *
     ...
     * @throws java.util.concurrent.TimeoutException if the lock was not available within
