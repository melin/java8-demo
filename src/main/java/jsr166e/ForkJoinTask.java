...
/**
 * Abstract base class for tasks that run within a {@link jsr166e.ForkJoinPool}.
 ...
 * explicitly submitted to a {@link jsr166e.ForkJoinPool}, or, if not already
 * engaged in a ForkJoin computation, commenced in the {@link
 * jsr166e.ForkJoinPool#commonPool()} via {@link #fork}, {@link #invoke}, or
 * related methods.  Once started, it will usually in turn start other
 * subtasks.  As indicated by the name of this class, many programs
 * using {@code ForkJoinTask} employ only methods {@link #fork} and
 * {@link #join}, or derivatives such as {@link
 * #invokeAll(jsr166e.ForkJoinTask...) invokeAll}.  However, this class also
 ...
 * jsr166e.ForkJoinPool.ManagedBlocker} API is used, or the number of possibly
 * blocked tasks is known to be less than the pool's {@link
 * jsr166e.ForkJoinPool#getParallelism} level, the pool cannot guarantee that
...
public abstract class ForkJoinTask<V> implements Future<V>, Serializable {
     ...
     * jsr166e.ForkJoinPool#commonPool()} if not {@link #inForkJoinPool}.  While
     ...
     * {@link jsr166e.ForkJoinPool#isQuiescent is quiescent}. This method may
