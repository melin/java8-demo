...
/**
 * A {@link jsr166y.ForkJoinTask} with a completion action performed when
 ...
 * status (as reported in methods such as {@link jsr166y.ForkJoinTask#isDone})
 * is arbitrary; this status changes only upon explicit invocations of
 * {@link #complete}, {@link jsr166y.ForkJoinTask#cancel}, {@link
 * jsr166y.ForkJoinTask#completeExceptionally} or upon exceptional completion
 ...
 * jsr166y.RecursiveAction}s, although the constructions involved in setting
 ...
 * (here, implicitly using the {@link jsr166y.ForkJoinPool#commonPool()}).
 *
 * <pre> {@code
...
public abstract class CountedCompleter<T> extends ForkJoinTask<T> {
     ...
     * jsr166y.ForkJoinTask#isCompletedAbnormally}.  The return value of this
     ...
     * jsr166y.ForkJoinTask#quietlyComplete} and returns {@code null}.  Or, if
